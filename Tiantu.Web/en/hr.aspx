<%@ Page Title="" Language="C#" MasterPageFile="~/en/MainEnUI.master" AutoEventWireup="true" CodeFile="hr.aspx.cs" Inherits="en_hr" %>
    ...
    <div class="tab">
        <div class="wp cl">
            <div class="curr">
                ...
                > <span><a href="HR.aspx">Human Resources</a></span>
            </div>
        </div>
    </div>
        ...
        <div class="hr wp">
            <div class="main">
                ...
                <div class=" hrright cl">
                    <div class="title">
                        <h5> Human Resources Exporting Solutions</h5>
                    </div>
