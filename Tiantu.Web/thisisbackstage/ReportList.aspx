<%@ Page Title="" Language="C#" MasterPageFile="~/thisisbackstage/Webadmin.master" AutoEventWireup="true" CodeFile="ReportList.aspx.cs" Inherits="webadmin_ReportList" %>
            ...
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                            ...
                            <asp:Repeater runat="server" ID="RepeaterStores" OnItemCommand="RepeaterStores_ItemCommand">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td><%# Eval("TITLE") %></td>
                                        <td>
                                            <%# Eval("Categorys.CATENAME") %>
                                        </td>
                                        
                                        <td><%# Eval("PUBDATE", "{0:yyyy-MM-dd}") %></td>
                                        <td style="text-align:center"><%# Eval("sortId") %></td>
                                        <td style="width: 120px;">
                                            <a href="ReportAdd.aspx?reportid=<%# Eval("REPORTID") %>" class="btn btn-info">编辑</a>
                                            <asp:LinkButton CommandName="delete" CommandArgument='<%# Eval("REPORTID") %>' Text="删除" ID="btnDelete"
                    ...
                    <div class="widget-bottom">
                        <a href="ReportAdd.aspx" class="btn btn-success">添加</a>
                    </div>
