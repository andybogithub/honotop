...
var TouchSlide = function(a) {
            ...
            for (var e in c) {
                ...
                for (var g in d)
                    ...
                    for (var h = d[g].getElementsByTagName("*"), i = 0; h.length > i; i++) {
                        ...
                        for (var h = d[g].getElementsByTagName(c[e]), i = 0; h.length > i; i++) f.push(h[i]);
                d = f
            }
    ...
    if (0 == p && (p = n), v) {
        ...
        if (1 == b.autoPage || "true" == b.autoPage)
            for (var Q = 0; p > Q; Q++) P += "<li>" + (Q + 1) + "</li>";
        else
            for (var Q = 0; p > Q; Q++) P += b.autoPage.replace("$", Q + 1);
    ...
    switch (i) {
        case "left":
            ...
            break;
        case "leftLoop":
            m.appendChild(m.children[0].cloneNode(!0)), m.insertBefore(m.children[n - 1].cloneNode(!0), m.children[0]), m.style.cssText = "width:" + (n + 2) * M + "px;" + "position:relative;overflow:hidden;padding:0;margin:0;";
