...
public partial class _shop_web__account_MyIndiana : System.Web.UI.Page
{
    ...
    private void ShowOrderProducts(int userId,int emplId)
    {
        ...
        int totalRecords = 0;
        DataSet dsList = dalShopStore.GetShopDubaoProductList(pageId, pageSize, strWhere, "", out totalRecords);
