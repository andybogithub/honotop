...
$(document).ready(function() {
	...
	$('#basic-datatables').dataTable({
		...
		"sDom": "<'row'<'col-md-6 col-xs-12'f><'col-md-6 col-xs-12'l>r>t<'row'<'col-md-4 col-xs-12'i><'col-md-8 col-xs-12'p>>"
	});
	...
	$('#tabletools').DataTable( {
		...
		tableTools: {
			"sSwfPath": "/_shop_admin/style/js/datatable/swf/copy_csv_xls_pdf.swf",
			"aButtons": [ 
		      "copy", 
		      "csv", 
		      "xls",
