<%@ Page Title="" Language="C#" MasterPageFile="~/_shop_admin/Share.master" AutoEventWireup="true" CodeFile="Add.aspx.cs" Inherits="_shop_admin_news_Add" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="page-title">
        <h3>最新消息</h3>
        <a href="list.aspx"><i class="fa fa-list"></i>最新消息查询</a>
        <a href="add.aspx" class="active"><i class="fa fa-plus"></i>添加最新消息</a>
    </div>
    <!--end page title-->
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="panel-box">
                <h4><a href="List.aspx">最新消息查询</a> <i class="fa fa-angle-right"></i>
                    <asp:Literal Text="添加" ID="lblPageAction" runat="server" />最新消息</h4>
