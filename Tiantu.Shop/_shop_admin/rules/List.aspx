<%@ Page Title="" Language="C#" MasterPageFile="~/_shop_admin/Share.master" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="_shop_admin_rules_List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="page-title">
        <h3>金币规则</h3>
        <a href="list.aspx" class="active"><i class="fa fa-list"></i>金币规则查询</a>
        <a href="add.aspx"><i class="fa fa-plus"></i>添加金币规则</a>
    </div>
    <!--end page title-->
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <div class="input-group m-b">
                                        <span class="input-group-addon">金币规则标题</span><input type="text" id="searchKey" placeholder="请输入关键词" value="<%=searchKey %>" class="form-control" />
