<%@ Page Title="" Language="C#" MasterPageFile="~/_shop_admin/Share.master" AutoEventWireup="true" CodeFile="Add.aspx.cs" Inherits="_shop_admin_rules_Add" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="page-title">
        <h3>金币规则</h3>
        <a href="list.aspx"><i class="fa fa-list"></i>金币规则查询</a>
        <a href="add.aspx" class="active"><i class="fa fa-plus"></i>添加金币规则</a>
    </div>
    <!--end page title-->
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="panel-box">
                <h4><a href="List.aspx">金币规则查询</a> <i class="fa fa-angle-right"></i>
                    <asp:Literal Text="添加" ID="lblPageAction" runat="server" />金币规则</h4>
                <hr />
