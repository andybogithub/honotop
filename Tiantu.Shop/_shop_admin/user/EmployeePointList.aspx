<%@ Page Title="" Language="C#" MasterPageFile="~/_shop_admin/Share.master" AutoEventWireup="true" CodeFile="EmployeePointList.aspx.cs" Inherits="_shop_admin_user_EmployeePointList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="page-title">
        <h3>会员金币中心</h3>
        <a href="UserPointList.aspx"><i class="fa fa-user-md"></i>会员金币查询</a>
        <a href="EmployeePointList.aspx"  class="on"><i class="fa fa-user"></i>员工金币查询</a> 
    </div>
    <!--end page title-->
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-sm-4">
                                    <div class="input-group m-b">
                                        <span class="input-group-addon">员工金币查询</span><input type="text" id="searchKey" placeholder="请输入您要查询的手机号码或姓名" value="<%=searchKey %>" class="form-control" />
