<%@ Page Title="" Language="C#" MasterPageFile="~/_shop_admin/Share.master" AutoEventWireup="true" CodeFile="Add.aspx.cs" Inherits="_shop_admin_product_Add" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="page-title">
        <h3>商品管理</h3>
        <a href="list.aspx"><i class="fa fa-list"></i>商品查询</a>
        <a href="add.aspx" class="active"><i class="fa fa-plus"></i>添加商品</a>
    </div>
    <!--end page title-->
        ...
        <div class="col-sm-12">
            <div class="panel-box">
                <h4>
                    ...
                    <a href="List.aspx">商品查询</a> <i class="fa fa-angle-right"></i>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row">
                                                    <div class="col-sm-2">
                                                        <asp:CheckBox Text="秒杀商品" ID="chkSeckillTag" runat="server" CssClass="checkbox-inline"  />
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <div class="input-group m-b">
                                                            <span class="input-group-addon">秒杀结束时间</span>
                                                            <asp:TextBox runat="server" ID="txtSeckillEndTime" CssClass="form-control datetimepicker" />

                                                     <span class="input-group-addon">秒杀优惠价格</span>
                                                            <asp:TextBox runat="server" ID="txtSeckillPoint" CssClass="form-control" /> 
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
